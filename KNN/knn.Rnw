...
<<fig=True,echo=False>>=
# Figure 1
plotter_samples(comparison_matrix, sample_matrix)
@
...
<<echo=FALSE>>=
list_results <- calc_knns(c(2, 4, 8), 2, comparison_matrix, sample_matrix)
@
...
<<fig=True,echo=False>>=
# Figure 1
plotter_samples(comparison_matrix, list_results[[1]])
@
...
<<fig=True,echo=False>>=
# Figure 1
plotter_samples(comparison_matrix, list_results[[2]])
@
...
<<fig=True,echo=False>>=
# Figure 1
plotter_samples(comparison_matrix, list_results[[3]])
@
...
%% Segunda parte 
<<echo=FALSE>>=
comparison_matrix <- build_gaussians(0.5, 100)
nc <- 20
sample_matrix <- matrix(runif(nc*2)-0.5, ncol=2) * 2 + t(matrix(c(3 ,3),
                                                        nrow=2,ncol=nc))
sample_matrix <- cbind(sample_matrix, matrix(data = 6, nrow = nc, ncol = 1))
...
%% Segunda parte 
<<echo=FALSE>>=
comparison_matrix <- build_gaussians(0.7, 100)
nc <- 20
sample_matrix <- matrix(runif(nc*2)-0.5, ncol=2) * 2 + t(matrix(c(3 ,3),
                                                        nrow=2,ncol=nc))
sample_matrix <- cbind(sample_matrix, matrix(data = 6, nrow = nc, ncol = 1))
